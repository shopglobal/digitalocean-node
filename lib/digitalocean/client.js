(function() {
  ...
  var Client = (function() {
    ...
    Client.prototype._callbackOrPromise = function(options, overrideOptions, successStatuses, successRootKeys, callback) {
      ...
      // if the immediate request returns an action, then poll until the
      // action is complete. Note this should be done before invoking the callback.
      deferred.then(function(object) {
        if (object._digitalOcean.body.action || object._digitalOcean.body.action) {
