  ...
  var Client = (function() {
    ...
    Client.prototype._buildrequestPromiseHandler = function(successStatuses, successRootKeys, resolve, reject) {
      ...
      return function(err, res, body) {
        ...
        //   result = new util.PaginatingArray(data, body.meta.total, requestOptions, successStatuses, successRootKeys);
        // }
    ...
    Client.prototype.get = function() {
      ...
      // TODO should this be nested like _digitalOcean ?
      options.query = query; // Copy query params into unused attribute for reuqest options for pagination
